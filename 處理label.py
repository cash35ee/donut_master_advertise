...
# 載入 CSV 檔案
csv_path = r"C:\Users\ccash\OneDrive\Desktop\project\標註結果1220.csv"  # 替換為您的 CSV 檔案路徑
image_folder = r"C:\Users\ccash\OneDrive\Desktop\project\final_database_photos"  # 替換為圖片所在資料夾的路徑
output_folder = "output1000_images"  # 替換為輸出圖片的資料夾路徑
output_jsonl = "output1000.jsonl"  # 替換成輸出的 JSONL 檔案
